...
public class AddSetFragment extends AddressBaseFragment {
...
//        if (addressBean != null) {
//            //编辑状态
//            state = SetAddressFragment.STATE.STATE_EDIT;
//            mTopBar.setTitle("修改收货地址");
//        } else {
//            //添加状态
            mTopBar.setTitle(ContantsName.NewLocation);
//            state = AddSetFragment.STATE.STATE_ADD;
//        }
//
//        if (state == SetAddressFragment.STATE.STATE_EDIT) {
...
//        if (state == SetAddressFragment.STATE.STATE_ADD) {
...
//            onChangeDataInUI(AddressActivity.class.getName());
            ...
            popBackStack();
//            finish();
//        } else if (state == SetAddressFragment.STATE.STATE_EDIT) {
//            //修改本地数据库
