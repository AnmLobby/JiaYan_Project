...
public class RegModel extends BaseModel {
        ...
        private Call<RegListBean> chefClassifyBeanCall;
        private Context context;
        private Api api;
    public RegModel(Context mContext){
        super();
        context=mContext;
  ...
  public void getRegList(final IBaseRequestCallBack<RegListBean> iBaseRequestCallBack){
    mcompositeDisposable.add(api.getCookRegList()
            .observeOn(AndroidSchedulers.mainThread())
            .subscribeOn(Schedulers.io())
            .subscribe(new Consumer<RegListBean>() {
                @Override
                public void accept(RegListBean chefDetailBannerBean) throws Exception {
