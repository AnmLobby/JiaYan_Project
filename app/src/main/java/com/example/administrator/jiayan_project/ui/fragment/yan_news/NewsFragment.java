...
public class NewsFragment extends AbstractMvpFragment<NewsListView, NewsListPresenter> implements NewsListView {
    ...
    protected View onCreateView() {
        FrameLayout layout = (FrameLayout) LayoutInflater.from(getActivity()).inflate(R.layout.fragment_news, null);
        ButterKnife.bind(this, layout);
        getPresenter().clickRequestHomeNews();
