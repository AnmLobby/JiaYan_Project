package com.example.administrator.jiayan_project.utils.update;
...
import com.example.administrator.jiayan_project.utils.util.SpUtils;
...
public class UpdateReceiver extends BroadcastReceiver {
    ...
    private void installApk(Context context,long did) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){
            ...
            //构建一个文件Uri
            Uri furi = FileProvider.getUriForFile(context,"com.example.administrator.jiayan_project.fileProvider",
                    new File(filePath));
