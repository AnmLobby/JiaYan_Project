package com.example.administrator.jiayan_project.utils.weight.image_detail;
...
public class ShowImagesDialog extends Dialog {
    ...
    public ShowImagesDialog(@NonNull Context context, int position, List<String> imgUrls) {
