...
public class ChefCommentAdapter extends SectionedRecyclerViewAdapter<CommentHolder, ImageHolder, RecyclerView.ViewHolder> {


    public List<ChefDetailMsgBean.EvaluateBean> allTagList;
    ...
    public ChefCommentAdapter(Context context) {
        mContext = context;
        mInflater = LayoutInflater.from(context);
        mBooleanMap = new SparseBooleanArray();
    }

    public void setData(List<ChefDetailMsgBean.EvaluateBean> allTagList) {
...
//            LogUtil.debug("timestamp2Date" + "将10位时间戳:" + str_num + "转化为字符串:", date);
    ...
    public interface OnChefCommentItemClickChefListener{
        void onLeftItemClick(int section,int position);
    }
    private OnChefCommentItemClickChefListener mOnLeftItemClickListener;

    public void setOnChefCommentItemClickListener(OnChefCommentItemClickChefListener onLeftItemClickListener) {
